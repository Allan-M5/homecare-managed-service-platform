...
export default function WorkerDashboardPage() {
  const { handleAccountDeletion, logout } = useAuth();
          ...
          <div className="card-stack" style={{ gap: "16px" }}>
            {assignedJobs.length === 0 ? (
              ...
              assignedJobs.map((job) => {
                ...
                const trackingOpen = ["worker_en_route", "worker_arrived", "work_in_progress", "awaiting_admin_clearance", "issue_reported", "issue_resolved"].includes(job.status) && !job.releasedAt && job.status !== "completed" && job.assignmentStatus !== "released";
...
<div className="action-row" style={{ gap: "12px", flexWrap: "wrap", alignItems: "center", marginTop: "10px" }}>
                      ...
                      {(stage.key === "accepted" || stage.key === "en_route") ? (
